...
@Target({TYPE, METHOD})
@Retention(RUNTIME)
public @interface AdfsAuthenticationDefinition {
    ...
    /**
     * Optional. the special resource attribute needed by Active Directory Federation Service
     * to locate the Web API of the Server Application to get defined claims.
     * 
     * If this isn't set it will have the value of clientid
     *
     * @return
     */
    ...
    /**
     * The Microprofile Config key for the resource is <code>{@value}</code>
     */
    public static final String OPENID_MP_RESOURCE = "payara.security.openid.resource";
