 ...
 * claims and OIDC provider related information.
 *
 * @author Gaurav Gupta
 */
public interface OidcContext extends Serializable {
     ...
     * Gets the User Claims that was received from the userinfo endpoint
     *
     * @return the {@link OidcClaims} instance
     */
    public OidcClaims getClaims();

    /**
     * The OIDC Provider's metadata document fetched via provider URI.
     *
     * @return
     */
