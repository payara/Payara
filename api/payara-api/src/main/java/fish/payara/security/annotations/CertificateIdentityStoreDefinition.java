...
/**
 * {@link CertificateIdentityStoreDefinition} annotation defines configuration
...
@Target({TYPE, METHOD})
@Retention(RUNTIME)
public @interface CertificateIdentityStoreDefinition {
     ...
     * property "payara.security.certificate.assignGroups".
     *
     * @return
     */
     ...
     * <code>{@value}</code>
     */
    String STORE_MP_CERTIFICATE_GROUPS = "payara.security.certificate.assignGroups";
