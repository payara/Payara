...
/**
 * {@link OidcProviderMetadata} annotation overrides the oidc provider's
 * endpoint value, discovered using providerUri.
 *
 * @author Gaurav Gupta
 */
@Retention(RUNTIME)
public @interface OidcProviderMetadata {
     ...
     * <code>{@value}</code>
     */
    public static final String OIDC_MP_AUTHORIZATION_ENDPOINT = "payara.security.oidc.provider.authorizationEndpoint";
     ...
     * {@code payara.security.oidc.provider.authorizationEndpoint}.
     *
     * @return
     */
     ...
     * <code>{@value}</code>
     */
    public static final String OIDC_MP_TOKEN_ENDPOINT = "payara.security.oidc.provider.tokenEndpoint";

    /**
     * Required. The URL for the OAuth2 provider to give the authorisation token
     * <p>
     * To set this using Microprofile Config use
     * {@code payara.security.oidc.provider.tokenEndpoint}
     * </p>
     *
     * @return
     */
     ...
     * <code>{@value}</code>
     */
    public static final String OIDC_MP_USERINFO_ENDPOINT = "payara.security.oidc.provider.userinfoEndpoint";
     ...
     * <p>
     * To set this using Microprofile Config use
     * {@code payara.security.oidc.provider.userinfoEndpoint}
     * </p>
     *
     * @return
     */
     ...
     */
    public static final String OIDC_MP_JWKS_URI = "payara.security.oidc.provider.jwksUri";

    /**
     * Required. An OIDC Provider's JSON Web Key Set document
     * <p>
     ...
     * </p>
     * To set this using Microprofile Config use
     * {@code payara.security.oidc.provider.jwksUri}
     *
     * @return
     */
