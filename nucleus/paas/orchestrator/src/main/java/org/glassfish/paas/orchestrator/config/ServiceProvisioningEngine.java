...
/**
 * ConfigBean representing the <service-provisioning-engine></service-provisioning-engine>  element
 *
 * @author  Sandhya Kripalani K
 */

@Configured
public interface ServiceProvisioningEngine extends ConfigBeanProxy,Injectable,PropertyBag{
