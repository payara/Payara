...
@Service
public class ProvisionerFactory<T extends Provisioner> {

    @Inject
    private Habitat habitat;

    public T getProvisioner(Properties metaData, Class clz) {

        Collection<Provisioner> provisioners = habitat.getAllByContract(clz);
