 ...
 */
@Service(name = "get-opentracing-configuration")
@PerLookup
...
@RestEndpoints({
    @RestEndpoint(configBean = OpenTracingServiceConfiguration.class,
            ...
            path = "get-opentracing-configuration",
            description = "Gets the OpenTracing Service Configuration")
})
public class GetOpenTracingServiceConfiguration implements AdminCommand {

    private final String OUTPUT_HEADERS[] = {"Tracer Factory Class Name"};
    ...
    public void execute(AdminCommandContext context) {
        ...
        Object[] outputValues = {
            openTracingServiceConfiguration.getTracerFactoryClassName()
        };        
        ...
        extraPropertiesMap.put("tracerFactoryClassName", openTracingServiceConfiguration.getTracerFactoryClassName());
        
        Properties extraProperties = new Properties();
        extraProperties.put("opentracingConfiguration", extraPropertiesMap);
