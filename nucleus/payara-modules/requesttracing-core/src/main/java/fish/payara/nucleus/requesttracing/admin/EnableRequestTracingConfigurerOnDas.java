...
@RestEndpoints({
    @RestEndpoint(configBean = Domain.class,
            ...
            path = "__enable-requesttracing-configure-das",
...
public class EnableRequestTracingConfigurerOnDas implements AdminCommand {
   ...
   final private static LocalStringManagerImpl strings = new LocalStringManagerImpl(EnableRequestTracingConfigurerOnDas.class);
