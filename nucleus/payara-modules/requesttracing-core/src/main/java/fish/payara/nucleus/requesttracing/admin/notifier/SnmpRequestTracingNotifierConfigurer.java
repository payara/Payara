 ...
 * @author mertcaliskan
 */
@Service(name = "requesttracing-snmp-notifier-configure")
@PerLookup
...
@RestEndpoints({
        @RestEndpoint(configBean = RequestTracingServiceConfiguration.class,
                ...
                path = "requesttracing-snmp-notifier-configure",
                description = "Configures SNMP Notifier for RequestTracing Service")
})
public class SnmpRequestTracingNotifierConfigurer extends BaseRequestTracingNotifierConfigurer<SnmpNotifier> {
