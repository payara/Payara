...
public class LogNotifierConfigurationExecutionOptions extends NotifierConfigurationExecutionOptions {
    ...
    public Boolean getUseSeparateLogFile() {
        return useSeparateLogFile;
    }

    public void setUseSeparateLogFile(Boolean useSeperateLogFile) {
        this.useSeparateLogFile = useSeperateLogFile;
    }

    @Override
    public String toString() {
        return "LogNotifierConfigurationExecutionOptions{" +
                "useSeparateLogFile=" + useSeparateLogFile +
                "} " + super.toString();
    }
}