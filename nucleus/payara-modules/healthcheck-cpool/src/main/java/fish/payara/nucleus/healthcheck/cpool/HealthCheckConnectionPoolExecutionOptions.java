...
public class HealthCheckConnectionPoolExecutionOptions extends HealthCheckWithThresholdExecutionOptions {
    ...
    public HealthCheckConnectionPoolExecutionOptions(boolean enabled, long time, TimeUnit unit, boolean addToMicroProfileHealth, String
            thresholdCritical, String thresholdWarning, String thresholdGood, String poolName) {
        super(enabled, time, unit, addToMicroProfileHealth, thresholdCritical, thresholdWarning, thresholdGood);
