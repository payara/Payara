 ...
 * @author mertcaliskan
 */
public class CDIEventbusMessageImpl extends Message implements EventbusMessage {
    ...
    public CDIEventbusMessageImpl(CDIEventbusNotificationEvent event, String subject, String message) {
