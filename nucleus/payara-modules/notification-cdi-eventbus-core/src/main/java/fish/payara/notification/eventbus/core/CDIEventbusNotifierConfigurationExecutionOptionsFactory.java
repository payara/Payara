...
public class CDIEventbusNotifierConfigurationExecutionOptionsFactory
    ...
    @PostConstruct
    void postConstruct() {
        registerExecutionOptions(NotifierType.CDIEVENTBUS, this);
    }

    @Override
    public CDIEventbusNotifierConfigurationExecutionOptions build(CDIEventbusNotifierConfiguration notifierConfiguration) throws UnsupportedEncodingException {
        CDIEventbusNotifierConfigurationExecutionOptions executionOptions = new CDIEventbusNotifierConfigurationExecutionOptions();
