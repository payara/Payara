...
public class CDIEventbusNotificationConfigurer extends BaseNotificationConfigurer<CDIEventbusNotifierConfiguration, CDIEventbusNotifierService> {
    ...
    protected String getHealthCheckNotifierCommandName() {
        return "healthcheck-cdieventbus-notifier-configure";
    }

    @Override
    protected String getRequestTracingNotifierCommandName() {
        return "requesttracing-cdieventbus-notifier-configure";
    }
}