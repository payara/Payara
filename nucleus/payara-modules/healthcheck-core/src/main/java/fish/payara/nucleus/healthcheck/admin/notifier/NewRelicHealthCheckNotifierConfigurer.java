...
@RestEndpoints({ @RestEndpoint(configBean = HealthCheckServiceConfiguration.class, opType = RestEndpoint.OpType.POST, path = "healthcheck-newrelic-notifier-configure", description = "Configures New Relic Notifier for HealthCheck Service") })
