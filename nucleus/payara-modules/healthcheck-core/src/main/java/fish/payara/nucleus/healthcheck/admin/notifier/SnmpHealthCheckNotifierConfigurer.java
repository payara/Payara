...
@RestEndpoints({ @RestEndpoint(configBean = HealthCheckServiceConfiguration.class, opType = RestEndpoint.OpType.POST, path = "healthcheck-snmp-notifier-configure", description = "Configures SNMP Notifier for HealthCheck Service") })
public class SnmpHealthCheckNotifierConfigurer extends BaseHealthCheckNotifierConfigurer<SnmpNotifier> {
    ...
    protected void applyValues(SnmpNotifier notifier) throws PropertyVetoException {
        ...
        if (this.noisy != null) {
            ...
            notifier.noisy(getNotifierNoisy("get-snmp-notifier-configuration"));
        }
    }
}