...
public interface HealthCheckConstants {
    ...
    final int THRESHOLD_DEFAULTVAL_CRITICAL_INT = 80;
    final String THRESHOLD_DEFAULTVAL_CRITICAL = "" + THRESHOLD_DEFAULTVAL_CRITICAL_INT;
    final int THRESHOLD_DEFAULTVAL_WARNING_INT = 50;
    final String THRESHOLD_DEFAULTVAL_WARNING = "" + THRESHOLD_DEFAULTVAL_WARNING_INT;
    final int THRESHOLD_DEFAULTVAL_GOOD_INT = 0;
    final String THRESHOLD_DEFAULTVAL_GOOD = "" + THRESHOLD_DEFAULTVAL_GOOD_INT;
