...
public class HealthCheckHoggingThreadsExecutionOptions extends HealthCheckExecutionOptions {
    ...
    public HealthCheckHoggingThreadsExecutionOptions(boolean enabled, long time, TimeUnit unit, boolean addToMicroProfileHealth,
            Long thresholdPercentage, int retryCount) {
