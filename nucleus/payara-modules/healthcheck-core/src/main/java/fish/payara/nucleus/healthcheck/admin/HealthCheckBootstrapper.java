...
@PerLookup
@I18n("bootstrap.healthcheck")
@RestEndpoints({
    @RestEndpoint(configBean = HealthCheckServiceConfiguration.class,
            opType = RestEndpoint.OpType.POST,
            path = "bootstrap-healthcheck",
            description = "Bootstraps Health Check Service")
})
public class HealthCheckBootstrapper implements AdminCommand {
