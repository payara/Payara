...
@RestEndpoints({ @RestEndpoint(configBean = HealthCheckServiceConfiguration.class, opType = RestEndpoint.OpType.POST, path = "healthcheck-eventbus-notifier-configure", description = "Configures Eventbus Notifier for HealthCheck Service") })
public class EventbusHealthCheckNotifierConfigurer extends BaseHealthCheckNotifierConfigurer<EventbusNotifier> {
    ...
    protected void applyValues(EventbusNotifier notifier) throws PropertyVetoException {
        ...
        if (this.noisy != null) {
            ...
            notifier.noisy(getNotifierNoisy("get-eventbus-notifier-configuration"));
        }
    }
}