...
@RestEndpoints({ @RestEndpoint(configBean = HealthCheckServiceConfiguration.class, opType = RestEndpoint.OpType.POST, path = "healthcheck-email-notifier-configure", description = "Configures Email Notifier for HealthCheck Service") })
