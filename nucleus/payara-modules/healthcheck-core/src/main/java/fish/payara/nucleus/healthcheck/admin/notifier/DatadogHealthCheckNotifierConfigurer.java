...
@RestEndpoints({ @RestEndpoint(configBean = HealthCheckServiceConfiguration.class, opType = RestEndpoint.OpType.POST, path = "healthcheck-datadog-notifier-configure", description = "Configures Datadog Notifier for HealthCheck Service") })
