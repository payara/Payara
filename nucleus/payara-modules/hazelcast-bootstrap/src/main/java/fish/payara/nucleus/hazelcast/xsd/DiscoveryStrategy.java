...
/**
 * <p>Java Class of discovery-strategy complex type.
 * 
 * 
 * 
 * <pre>
 * &lt;complexType name="discovery-strategy">
 *   &lt;complexContent>
...
@XmlType(name = "discovery-strategy", namespace = "http://www.hazelcast.com/schema/config", propOrder = {
    "properties"
})
public class DiscoveryStrategy {
    ...
    /**
     * Gets the value of property clazz.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of property clazz.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
