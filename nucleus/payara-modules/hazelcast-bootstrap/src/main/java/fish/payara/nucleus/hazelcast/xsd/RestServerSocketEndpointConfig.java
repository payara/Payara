 ...
 *             
 * 
 * <p>Java Class of rest-server-socket-endpoint-config complex type.
 * 
 * 
 * 
 * <pre>
 * &lt;complexType name="rest-server-socket-endpoint-config">
 *   &lt;complexContent>
 ...
 *         &lt;element name="endpoint-groups" type="{http://www.hazelcast.com/schema/config}endpoint-groups" minOccurs="0"/>
 *       &lt;/all>
...
@XmlType(name = "rest-server-socket-endpoint-config", namespace = "http://www.hazelcast.com/schema/config", propOrder = {

})
public class RestServerSocketEndpointConfig {
    ...
    @XmlElement(name = "endpoint-groups", namespace = "http://www.hazelcast.com/schema/config")
    protected EndpointGroups endpointGroups;
    ...
    /**
     * Gets the value of property endpointGroups.
     * 
     * @return
     *     possible object is
     *     {@link EndpointGroups }
    ...
    /**
     * Sets the value of property endpointGroups.
     * 
     * @param value
     *     allowed object is
     *     {@link EndpointGroups }
     *     
     */
    public void setEndpointGroups(EndpointGroups value) {
        this.endpointGroups = value;
    }
