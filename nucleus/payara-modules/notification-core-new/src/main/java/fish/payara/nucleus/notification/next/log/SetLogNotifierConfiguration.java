 ...
 * @author mertcaliskan
 */
@Service(name = "new-notification-log-configure")
@PerLookup
...
@RestEndpoints({
        @RestEndpoint(configBean = Domain.class,
                ...
                path = "new-notification-log-configure",
                description = "Configures Log Notification Service")
})
public class SetLogNotifierConfiguration extends BaseSetNotifierConfiguration<NewLogNotifierConfiguration, LogNotifier> {

    @Param(name = "useSeparateLogFile", defaultValue = "false", optional = true)
    private String useSeparateLogFile;

    @Override
    protected void applyValues(NewLogNotifierConfiguration configuration) throws PropertyVetoException {
