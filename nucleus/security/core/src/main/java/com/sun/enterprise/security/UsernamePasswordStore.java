...
/**
 * This class is used to share information between either of the following scenarios 1. Different points of execution of
 * a single thread 2. Different threads that wish to share the username and password information
 * 
 * Which of the above two condition is applicable depends upon the system property key
 * "com.sun.appserv.iiopclient.perthreadauth"; When set to true, scenario #1 above applies and the username/password
 * information is not shared between threads. When set to false, scenario #2 above applies and the username/password
