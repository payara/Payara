...
/**
 * Abstract base class for password-based login modules. This class is provided for backward compatibility and is a
...
public abstract class PasswordLoginModule extends BasePasswordLoginModule {
     ...
     *
     * <P>
     * This is a convenience method which can be used by subclasses to complete the steps required by RI legacy
     * authentication code. Most of this should go away if a clean JAAS/Subject based infrastructure is provided. But for
    ...
    /**
     * Since the passwords are to be stored as to have char[] BT: 6946553. Retaining the other method for backward
     * compatability
     *
     * @param username Name of authenticated user.
    ...
    /**
     * Perform authentication decision. Method returns silently on success and returns a LoginException on failure. To be
     * implmented by sub-classes
     * 
