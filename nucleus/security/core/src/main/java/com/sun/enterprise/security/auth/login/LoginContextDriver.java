...
import static com.sun.enterprise.security.auth.realm.Realm.getDefaultRealm;
import static com.sun.enterprise.security.auth.realm.Realm.isValidRealm;
...
public class LoginContextDriver {
     ...
     *
     * <p>
     * The difference between this method and others is that it just
     ...
     */
    public static Subject jaspicValidateUsernamePassword(Subject subject, String username, char[] password, String realm) throws LoginException {
    ...
    public static Subject jaspicX500Login(Subject subject, X500Principal x500Principal) throws LoginException {
        Subject validSubject = getValidSubject(subject);
    ...
    public static Subject jaspicAddRealmGroupsToSubject(Subject subject, String callerPrincipalName, String realmName) throws LoginException {
    ...
    private static void validateJaasLogin(String username, String jaasCtx, String realm, Subject subject) {
        try {
    ...
    private static void tryJaasLogin(String jaasCtx, Subject subject) throws javax.security.auth.login.LoginException  {
    ...
    //  ###### Hardcoded login types from login(Subject, Class<?>)
    ...
    private static Subject getValidSubject(Subject subject) {
        if (subject == null) {
            return new Subject();
        }
    ...
    private static String getValidRealm(String realm) {
    ...
    private static String getJaasContext(String realm) {
        try {
    ...
    private static Realm getRealmInstance(String realmName) throws NoSuchRealmException {
    ...
    private static void throwLoginException(Exception exception) {
        throwLoginException(exception, e -> "Login failed: " + e.getMessage());
    }

    private static void throwLoginException(Exception e, Function<Exception, String> exceptionStringFn) {
     ...
     *
     */
    private static <T> T getPublicCredentials(Subject s, Class<T> cls) throws LoginException {
    ...
    private static void auditAuthenticate(String username, String realm, boolean success) {
