 ...
 * <code>com.sun.enterprise.security.auth.login</code> package.
 * 
 * <p>
 * A Realm contains the actual credential validation functionality of an identity store,
 * but can additionally contain user management (create, update delete) functionality as well.  
 *
 */
