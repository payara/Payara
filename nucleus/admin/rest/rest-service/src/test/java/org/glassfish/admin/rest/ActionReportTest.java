...
//    }
    ...
    private String marshal(RestActionReporter ar) throws IOException {
    ...
    private String basicMarshalTest(RestActionReporter ar) throws IOException {
    ...
    @Test(groups="offline")
    public void actionReportMrshalingTest1() throws IOException {
