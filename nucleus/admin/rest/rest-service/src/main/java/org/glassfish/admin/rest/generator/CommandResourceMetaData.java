...
public class CommandResourceMetaData {
    ...
    public String toString() {
        return "CommandResourceMetaData{" + "command=" + command + ", httpMethod=" + httpMethod + ", resourcePath=" + resourcePath + ", displayName=" + displayName + ", commandParams=" + commandParams + ", customClassName=" + customClassName + '}';
    }
...
//        {"Cluster", "delete-cluster", "POST", "delete-cluster", "Delete Cluster", "id=$parent"}, // FIXME: Should be DELETE // @RestRedirect
...
//        {"Domain", "_create-node", "POST", "_create-node", "_create-node"}, // @RestRedirect
...
//        {"Domain", "_register-instance", "POST", "_register-instance", "_register-instance"}, // CRUD
...
//        {"Domain", "_unregister-instance", "POST", "_unregister-instance", "_unregister-instance"}, // CRUD
...
//        {"LbConfigs", "list-http-lbs", "GET", "list-http-lbs", "list-http-lbs"}, // CRUD
//        {"ListApplication", "__list-webservices", "GET", "list-webservices", "List Webservices"}, // Attached to Application
//        {"ListApplication", "_get-context-root", "GET", "get-context-root", "Get Context Root"},
//        {"ListApplication", "_get-relative-jws-uri", "GET", "_get-relative-jws-uri", "Get Relative JWS URI"}, // Attached to Application
//        {"ListApplication", "_is-sniffer-user-visible", "GET", "is-sniffer-user-visible", "Is Sniffer User Visible"}, // Attached to Application
...
//        {"Node", "_delete-node", "DELETE", "delete-node", "Delete Node", "id=$parent"}, // CRUD
...
//        {"Server", "delete-http-redirect", "DELETE", "delete-http-redirect", "delete-http-redirect"},
//        {"Server", "enable-http-lb-server", "POST", "enable-http-lb-server", "enable-http-lb-server", "id=$parent"},
