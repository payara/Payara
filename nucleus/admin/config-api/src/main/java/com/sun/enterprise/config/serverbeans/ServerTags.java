...
//public static final String WEB_CONTAINER = "web-container";
    ...
    public static final String SEC_ADMIN_LISTENER_PROTOCOL_NAME = "sec-admin-listener";
    public static final String REDIRECT_PROTOCOL_NAME = "admin-http-redirect";
    public static final String PORT_UNIF_PROTOCOL_NAME = "pu-protocol";
}
