...
public final class LogQueryResultImpl implements LogQueryResult {
    ...
    private final LogQueryEntry[] mEntries;

    public LogQueryResultImpl(final String[] fieldNames, final LogQueryEntry[] entries) {
        mFieldNames = fieldNames;
        mEntries = entries;
    }

    /**
     * Instantiate using result from {@link Logging#queryServerLog}. The first Object[] is a String[] of the field names. Subsequent Object[] are the data
     * values.
     */
    public LogQueryResultImpl(final List<Serializable[]> records) {
