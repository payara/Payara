...
public class AMXLoggerInfo {
    ...
    @LogMessageInfo(
            ...
            level = "WARNING")
    public static final String shutdownNotUnregistered = LOGMSG_PREFIX + "-002";

    @LogMessageInfo(
            message = "Fatal error loading AMX {0}",
            level = "INFO")
    public static final String fatalError = LOGMSG_PREFIX + "-004";

    @LogMessageInfo(
            message = "AMX Startup Service: AMXLoader failed to load {0}",
            level = "INFO")
    public static final String failToLoad = LOGMSG_PREFIX + "-008";

    @LogMessageInfo(
            message = "AMX Startup Service: AMX ready for use, DomainRoot {0}",
            level = "INFO")
    public static final String startupServiceDomainRoot = LOGMSG_PREFIX + "-009";

    @LogMessageInfo(
            message = "AMXLoader failed to unload: {0}",
            level = "INFO")
    public static final String failToUnLoad = LOGMSG_PREFIX + "-010";

    @LogMessageInfo(
            message = "ConfigBean not processed, something wrong with it {0}",
            level = "INFO")
    public static final String configBeanNotProcessed = LOGMSG_PREFIX + "-011";

    @LogMessageInfo(
            message = "In AMXConfigLoader : Loading {0}",
            level = "INFO")
    public static final String inAMXConfigLoader = LOGMSG_PREFIX + "-012";

    @LogMessageInfo(
            message = "Can't unregister MBean: {0}",
            level = "INFO")
    public static final String unregisterMbean = LOGMSG_PREFIX + "-019";

    @LogMessageInfo(
            message = "Non-singleton ConfigBean {0} has empty key value (name), supplying {1}",
            level = "WARNING")
    public static final String nonsingletonConfigbean = LOGMSG_PREFIX + "-020";

    @LogMessageInfo(
            message = "AMX ComplianceMonitor: ValidationLevel = {0}, UnregisterNonCompliant = {1}, LogInaccessibleAttributes = {2}",
            level = "INFO")
    public static final String aMXComplianceMonitorLevel = LOGMSG_PREFIX + "-021";
    ...
    @LogMessageInfo(
            ...
            level = "SEVERE")
    public static final String aMXComplianceMonitorThreadquit = LOGMSG_PREFIX + "-022";

    @LogMessageInfo(
            message = "Validating MBean {0}",
            level = "INFO")
    public static final String validatingMbean = LOGMSG_PREFIX + "-023";

    @LogMessageInfo(
            message = "Exception validating MBean {0}",
            level = "WARNING")
    public static final String exceptionValidatingMbean = LOGMSG_PREFIX + "-024";

    @LogMessageInfo(
            message = "Register children for instance name {0}",
            level = "INFO")
    public static final String registerChild = LOGMSG_PREFIX + "-025";

    @LogMessageInfo(
            message = "AMX Attribute Change Notification for {0}",
            level = "INFO")
    public static final String attributeChangeNotification = LOGMSG_PREFIX + "-027";
    ...
    @LogMessageInfo(
            ...
            action = "Check the server logs and contact Oracle support.",
            level = "SEVERE")
    public static final String attributeNotfound = LOGMSG_PREFIX + "-030";
    ...
    @LogMessageInfo(
            ...
            action = "Check the server logs and contact Oracle support.",
            level = "SEVERE")
    public static final String childNotfound = LOGMSG_PREFIX + "-031";

    @LogMessageInfo(
            message = "MBeans exist in AMX domain prior to DomainRoot (violates Parent requirement): {0}",
            level = "INFO")
    public static final String mbeanExist = LOGMSG_PREFIX + "-032";  
    
    @LogMessageInfo(
            message = "Can't register config MBean: type={0}, name={1}, exception={2}",
            level = "WARNING")
    public static final String cantRegister = LOGMSG_PREFIX + "-033";  
    ...
    @LogMessageInfo(
            ...
            action = "Check the server logs and contact Oracle support.",
            level = "SEVERE")
    public static final String unexpectedDeath = LOGMSG_PREFIX + "-034";  
    
    @LogMessageInfo(
            message = "Can't create children",
            level = "INFO")
    public static final String cantCreateChildren = LOGMSG_PREFIX + "-035";  
    
    @LogMessageInfo(
            message = "AMXConfigStartupService.preDestroy(): stopping AMX" ,
            level = "INFO")
    public static final String stoppingAMX = LOGMSG_PREFIX + "-036";  
    
    @LogMessageInfo(
            message = "Illegal non-string type for {0}.{1}(): {2}",
            level = "INFO")
    public static final String illegalNonstring = LOGMSG_PREFIX + "-037";  
    
    @LogMessageInfo(
            message = "Can't get field value for {0}: exception: {1}",
            level = "INFO")
    public static final String cantGetField = LOGMSG_PREFIX + "-038";  
    
    @LogMessageInfo(
            message = "Can't getTypesImplementing for {0}: exception: {1}",
            level = "INFO")
    public static final String cantGetTypesImplementing = LOGMSG_PREFIX + "-039";  
    
    @LogMessageInfo(
            message = "Can't get childrenSet() from MBean: {0}, exception: {1}",
            level = "WARNING")
    public static final String cantGetChildren = LOGMSG_PREFIX + "-040";  
    
    @LogMessageInfo(
            message = "Problem with MBean: {0}, exception: {1}" ,
            level = "WARNING")
    public static final String problemWithMbean = LOGMSG_PREFIX + "-041";  
    
    @LogMessageInfo(
            message = "PathnamesImpl.getAllPathnames(): unexpected Throwable: {1}" ,
            level = "WARNING")
    public static final String unexpectedThrowable = LOGMSG_PREFIX + "-042";  
    
    @LogMessageInfo(
            message = "Can't get path() for MBean: {0}, exception: {1}" ,
            level = "WARNING")
    public static final String cantGetPath = LOGMSG_PREFIX + "-043";  
    
    @LogMessageInfo(
            message = "Can't instantiate realm: {0}, exception: {1}" ,
            level = "WARNING")
    public static final String cantInstantiateRealm = LOGMSG_PREFIX + "-044";  
    
    @LogMessageInfo(
            message = "getRealmNames(): Can't get realm names, exception:" ,
            level = "WARNING")
    public static final String cantGetRealmNames = LOGMSG_PREFIX + "-045";  
    
    @LogMessageInfo(
            message = "Cannot find primordial com.sun.enterprise.osgi-adapter" ,
            level = "WARNING")
    public static final String cantFindOSGIAdapter = LOGMSG_PREFIX + "-046";  
    
    @LogMessageInfo(
            message = "Stopping server forcibly",
            level = "WARNING")
    public static final String stoppingServerForcibly = LOGMSG_PREFIX + "-047";  
    
    @LogMessageInfo(
            message = "Can't get cipher suites",
            level = "INFO")
    public static final String cantGetCipherSuites = LOGMSG_PREFIX + "-048";  
    
    @LogMessageInfo(
            message = "MBeanInfoSupport: @ManagedAttribute cannot also be @ManagedOperation: {0}.{1}()",
            level = "WARNING")
    public static final String attributeCantBeOperation = LOGMSG_PREFIX + "-049";  
    
    @LogMessageInfo(
            message = "MBeanInfoSupport: @ManagedAttribute not a getter or setter: {0}.{1}()",
            level = "WARNING")
    public static final String attributeNotGetterSetter = LOGMSG_PREFIX + "-050";  
