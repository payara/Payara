 ...
 * @author savage
 */
public class AMXBoot implements Runnable {
    ...
    private Logger LOGGER = AMXLoggerInfo.getLogger();
    ...
    /**
     * Class runnable method. Boots AMX by invoking the bootAMX operation on the boot-amx MBean.
     */
    @Override
    public void run() {
        try {
