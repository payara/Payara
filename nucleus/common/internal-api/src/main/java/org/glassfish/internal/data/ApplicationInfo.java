...
/**
 * Information about a running application. Applications are composed of
 * modules. Modules run in an individual container.
 *
...
public class ApplicationInfo extends ModuleInfo {
    ...
    /**
     * The prefix that will be given to the service locator, followed by the
     * name of the application
     */
    public static final String APP_SERVICE_LOCATOR_PREFIX = "JavaEEApp.";

    private final Collection<ModuleInfo> modules = new ArrayList<>();
    ...
    public <T extends Container> Collection<EngineRef> getEngineRefsForContainer(Class<T> type) {
        Set<EngineRef> refs = new LinkedHashSet<>();
     ...
     * META-INF/hk2-locator/application. {@link PopulationPostProcessor} may be
     * defined in the META-INF/services standard way
     *
