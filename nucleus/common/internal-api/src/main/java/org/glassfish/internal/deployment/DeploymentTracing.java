...
public class DeploymentTracing {
    ...
    public enum AppStage {
        ...
        DETERMINE_APP_NAME,
        PROVIDE_APPINFO,
        READ_DESCRIPTORS, CLEANUP, SWITCH_VERSIONS, DEPLOY, PREPARE, INITIALIZE, REGISTRATION, CLASS_SCANNING, CONTAINER_START, LOAD_METADATA, CREATE_CLASSLOADER, PREPARE_MODULES, LOAD, PREPARE_EVENTS;
