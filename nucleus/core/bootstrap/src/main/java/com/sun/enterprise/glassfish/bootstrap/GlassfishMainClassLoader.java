 ...
 */
public class GlassfishMainClassLoader extends GlassfishUrlClassLoader {
     ...
     */
    public GlassfishMainClassLoader(final File glassfishDir, final ClassLoader parent) throws IOException {
