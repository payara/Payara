...
/**
 * Deletes a single JVM option in server's configuration.
 * Thin wrapper around {@link DeleteJvmOptions} for single-operand convenience.
 */
...
public final class DeleteJvmOption implements AdminCommand, AdminCommandSecurity.Preauthorization {
    ...
    @Inject
    DeleteJvmOptions delegate;

    @Override
    public boolean preAuthorization(AdminCommandContext context) {
        delegate.target = target;
        delegate.jvmOptions = List.of(jvmOption);
        return delegate.preAuthorization(context);
    }
