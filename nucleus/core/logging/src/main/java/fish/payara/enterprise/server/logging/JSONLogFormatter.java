...
public class JSONLogFormatter extends Formatter implements LogEventBroadcaster {
    ...
    private String jsonLogFormat(LogRecord record) {
        try {
            ...
            jsonBuilder.add(TIMESTAMP_KEY, timestampValue);
            ...
            jsonBuilder.add(LOG_LEVEL_KEY, String.valueOf(eventLevel));
            ...
            jsonBuilder.add(PRODUCT_ID_KEY, productId);
            ...
            jsonBuilder.add(LOGGER_NAME_KEY, loggerName);
            ...
            if (!excludeFieldsSupport.isSet(ExcludeFieldsSupport
                ...
                jsonBuilder.add(THREAD_ID_KEY, String.valueOf(threadId));
                ...
                jsonBuilder.add(THREAD_NAME_KEY, threadName);
            }
            ...
            if (!excludeFieldsSupport.isSet(ExcludeFieldsSupport
                ...
                if (null != userId && !userId.isEmpty()) {
                    jsonBuilder.add(USER_ID_KEY, userId);
                }
            }
            ...
            if (!excludeFieldsSupport.isSet(ExcludeFieldsSupport
                ...
                jsonBuilder.add(TIME_MILLIS_KEY, String.valueOf(timestamp));
            }
            ...
            if (!excludeFieldsSupport.isSet(ExcludeFieldsSupport
                ...
                jsonBuilder.add(LEVEL_VALUE_KEY, String.valueOf(levelValue));
            }
            ...
            if (messageId != null && !messageId.isEmpty()) {
                ...
                jsonBuilder.add(MESSAGE_ID_KEY, messageId);
            }
            ...
            if (LOG_SOURCE_IN_KEY_VALUE || 
                ...
                if (null != sourceClassName && !sourceClassName.isEmpty()) {
                    ...
                    jsonBuilder.add(CLASS_NAME, sourceClassName);
                }
                ...
                if (null != sourceMethodName && !sourceMethodName.isEmpty()) {
                    ...
                    jsonBuilder.add(METHOD_NAME, sourceMethodName);
                }
            }
            ...
            if (RECORD_NUMBER_IN_KEY_VALUE) {
                ...
                jsonBuilder.add(RECORD_NUMBER, String.valueOf(recordNumber));
            }

            if (null != _delegate) {
                _delegate.format(new StringBuilder()
                        .append(jsonBuilder.toString()), level);
            }
            ...
            if (null == logMessage || logMessage.trim().equals("")) {
                ...
                if (null != throwable) {
                    try (StringWriter stringWriter = new StringWriter(); 
                        ...
                        traceBuilder.add(EXCEPTION_KEY, throwable.getMessage());
                        traceBuilder.add(STACK_TRACE_KEY, logMessage);
                        logEvent.setMessage(logMessage);
                        jsonBuilder.add(LOG_MESSAGE_KEY, traceBuilder);
                    }
                } 
            } else {
                ...
                if (null != throwable) {
                    try (StringWriter stringWriter = new StringWriter(); 
                        ...
                        throwable.printStackTrace(printWriter);
                        logMessage = stringWriter.toString();
                        traceBuilder.add(EXCEPTION_KEY, logMessageBuilder.toString());
                        traceBuilder.add(STACK_TRACE_KEY, logMessage);
                        logEvent.setMessage(logMessage);
                        jsonBuilder.add(LOG_MESSAGE_KEY, traceBuilder);
                    }
                    ...
                    logEvent.setMessage(logMessage);
                    jsonBuilder.add(LOG_MESSAGE_KEY, logMessage);
                }
            }

            informLogEventListeners(logEvent); 
            return jsonBuilder.build().toString() + LINE_SEPARATOR;
