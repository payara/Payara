 ...
 */
public class ExtendedLogFormatHelperTest {
    ...
    private static final String RANDOM_RECORD = "affq fiqrefgqr yfgqfqgfgr fgqerfuyirg qyeirfg ergf";

    private final ExtendedLogFormatHelper helper = new ExtendedLogFormatHelper();


    @Test
    public void json() {
        assertTrue(helper.isJSONFormatLogHeader(JSON_RECORD));
        assertFalse(helper.isODLFormatLogHeader(JSON_RECORD));
        assertFalse(helper.isUniformFormatLogHeader(JSON_RECORD));
        assertEquals(JSONLogFormatter.class.getName(), helper.detectFormatter(JSON_RECORD));
    }

    @Test
    public void odl() {
        assertFalse(helper.isJSONFormatLogHeader(ODL_RECORD));
    ...
    @Test
    public void uniform() {
        assertFalse(helper.isJSONFormatLogHeader(ULF_RECORD));
    ...
    @Test
    public void unknown() {
        assertFalse(helper.isJSONFormatLogHeader(RANDOM_RECORD));
