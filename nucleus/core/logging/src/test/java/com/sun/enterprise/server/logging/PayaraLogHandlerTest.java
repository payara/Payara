...
public class PayaraLogHandlerTest {
    ...
    public void init() throws Exception {
        cfg = new PayaraLogHandlerConfiguration();
        cfg.setLogFile(File.createTempFile(getClass().getCanonicalName(), ".log"));
    ...
    public void resetStreams() {
        System.setOut(logManager.getOriginalStdOut());
        System.setErr(logManager.getOriginalStdErr());
    }
