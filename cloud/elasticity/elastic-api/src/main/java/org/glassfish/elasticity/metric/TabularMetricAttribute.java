...
/**
 * A TabularMetricAttribute is a MetricAttribute whose data
 * 	is kept in a tabular form. The list of column names can be
 *  retrieved using getColumnNames, whereas an individual attribute's
 *  value can be retrieved using getValue() method (defined in the 
 *  super class).
 *  
...
public interface TabularMetricAttribute<V>
	...
	/**
	 * 
	 * @return The columnNames in any entry
	 */
