 ...
 * holder.
 */
package fish.payara.extras.payaramicro.ejar;

import fish.payara.extras.payaramicro.loader.ExecutableArchiveLauncher;
import fish.payara.extras.payaramicro.loader.archive.Archive;
...
public class PayaraMicroLauncher extends ExecutableArchiveLauncher {
    ...
    public static void main(String args[]) throws Exception {
        new PayaraMicroLauncher().launch(args);
    }
    ...
    protected boolean isNestedArchive(Archive.Entry entry) {
        ...
        if (entry.isDirectory() && entry.getName().equals("MICRO-INF/classes/")) {
            result = true;
        } else if (entry.getName().startsWith("MICRO-INF/lib/") || entry.getName().startsWith("MICRO-INF/modules/")) {
            result = true;
        }
        return result;
    }
