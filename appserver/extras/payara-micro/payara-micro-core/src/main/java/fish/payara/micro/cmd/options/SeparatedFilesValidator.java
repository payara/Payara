 ...
 */
public class SeparatedFilesValidator extends FileSystemItemValidator {

    public SeparatedFilesValidator(boolean exists, boolean readable, boolean writable, boolean filesAllowed, boolean directoryAllowed) {
