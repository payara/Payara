...
/**
 * Command to add a key or certificate to the target instance or listener's trust store.
 *
 * @author Jonathan Coustick
 * @author Andrew Pielage
 */
@Service(name = "add-to-truststore")
@PerLookup
public class AddToTrustStoreCommand extends AbstractCertManagementCommand {
    ...
    protected int executeCommand() throws CommandException {
        ...
        if (target != null && !target.equals(SystemPropertyConstants.DAS_SERVER_NAME)) {
            AddToTrustStoreLocalInstanceCommand localInstanceCommand =
                    new AddToTrustStoreLocalInstanceCommand(programOpts, env);
    ...
    private class AddToTrustStoreLocalInstanceCommand extends AbstractLocalInstanceCertManagementCommand {

        public AddToTrustStoreLocalInstanceCommand(ProgramOptions programOpts, Environment env) {
