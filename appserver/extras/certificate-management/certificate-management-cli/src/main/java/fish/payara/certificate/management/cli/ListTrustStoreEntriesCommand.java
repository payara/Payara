...
public class ListTrustStoreEntriesCommand extends AbstractListStoreEntriesCommand {
    ...
    protected int executeCommand() throws CommandException {
        ...
        if (target != null && !target.equals(SystemPropertyConstants.DAS_SERVER_NAME)) {
            ListTrustStoreEntriesLocalInstanceCommand localInstanceCommand =
                    new ListTrustStoreEntriesLocalInstanceCommand(programOpts, env);
        ...
        listEntries(truststore, truststorePassword);
