...
public class ListKeystoreEntriesCommand extends AbstractListStoreEntriesCommand {
    ...
    protected int executeCommand() throws CommandException {
        ...
        if (target != null && !target.equals(SystemPropertyConstants.DAS_SERVER_NAME)) {
            ListKeystoreEntriesLocalInstanceCommand localInstanceCommand =
                    new ListKeystoreEntriesLocalInstanceCommand(programOpts, env);
        ...
        listEntries(keystore, keystorePassword);
