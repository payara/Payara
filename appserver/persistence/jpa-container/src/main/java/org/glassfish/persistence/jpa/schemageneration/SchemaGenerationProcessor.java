...
public interface SchemaGenerationProcessor {
    ...
    /**
     * @return overrides that will be supplied at EMF creation to accommodate schema generation
     */
    Map<String, String> getSchemaGenerationOverrides();

    /**
     * @return whether ddl needs to be executed by container
     */
    boolean isDDLExecutionRequired();
