...
public class AdministeredObjectDefinitionDescriptor extends Descriptor {
    ...
    public boolean equals(Object object) {
        if (object instanceof AdministeredObjectDefinitionDescriptor) {
            AdministeredObjectDefinitionDescriptor reference = (AdministeredObjectDefinitionDescriptor) object;
