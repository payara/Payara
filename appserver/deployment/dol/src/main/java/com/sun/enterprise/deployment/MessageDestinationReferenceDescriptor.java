...
public class MessageDestinationReferenceDescriptor extends EnvironmentProperty
    ...
    */
    ...
    public void print(StringBuilder toStringBuilder) {
	    ...
	    toStringBuilder.append("Resolved Message-Destination-Ref ").append(getName()).append(
                "points to logical message destination ").append(getMessageDestination().getName());
	} else {
	    toStringBuilder.append("Unresolved Message-Destination-Ref ").append(getName()).append(
