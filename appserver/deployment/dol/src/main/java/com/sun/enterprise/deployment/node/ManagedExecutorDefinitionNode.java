...
public class ManagedExecutorDefinitionNode extends DeploymentDescriptorNode<ConcurrentDefinitionDescriptor> {
    ...
    protected Map getDispatchTable() {
        ...
        table.put(TagNames.MANAGED_EXECUTOR_MAX_POOL_SIZE, "setMaximumPoolSize");
        table.put(TagNames.MANAGED_EXECUTOR_HUNG_AFTER_SECONDS, "setHungAfterSeconds");
        table.put(TagNames.MANAGED_EXECUTOR_CONTEXT_INFO, "setContextInfo");
        return table;
    }
