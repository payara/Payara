...
public final class DTDRegistry {
    ...
    public static final String DTD_LOCATION = System.getProperty("com.sun.aas.installRoot") +
            java.io.File.separator + "lib" + java.io.File.separator + "dtds";
     
    public static final String SCHEMA_LOCATION = System.getProperty("com.sun.aas.installRoot") +
