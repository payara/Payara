...
//        versionSet = true;
    ...
    */
    ...
    {
        StringBuilder buf = toStringBuffer;
        super.print(buf);

	buf.append("\n displayName : ").append(super.getName());
	buf.append("\n connector_description : ").append(connectorDescription);
	buf.append("\n smallIcon : ").append(super.getSmallIconUri());
	buf.append("\n largeIcon : ").append(super.getLargeIconUri());
	buf.append("\n vendorName : ").append(vendorName);
	buf.append("\n eisType : ").append(eisType);
	buf.append("\n resourceadapter version : ").append(resourceAdapterVersion);

        //license info
        if (getLicenseDescriptor() != null) {
 	    buf.append("\n license_description : ").append(getLicenseDescriptor().getDescription());
       	    buf.append("\n licenseRequired : ").append(getLicenseDescriptor().getLicenseRequiredValue());
        }

	buf.append("\n resourceAdapterClass : ").append(resourceAdapterClass);

	buf.append("\n resourceAdapterClass [").append(resourceAdapterClass).append("] config properties :");
    ...
    private StringBuilder appendConfigProperties (Set props, StringBuilder buf)
    {
        buf.append("\n------------");
        for (Object prop : props) {
            ConnectorConfigProperty config = (ConnectorConfigProperty) prop;
            buf.append("[Name : ").append(config.getName()).append("], ");
            buf.append("[Value: ").append(config.getValue()).append("], ");
            buf.append("[Type : ").append(config.getType()).append("]");
            buf.append("[Confidential : ").append(config.isConfidential()).append("]");
            buf.append("[Ignore : ").append(config.isIgnore()).append("]");
            buf.append("[SupportsDynamicUpdates : ").append(config.isSupportsDynamicUpdates()).append("]");
        }
        buf.append("\n------------");
        return buf;
    }
