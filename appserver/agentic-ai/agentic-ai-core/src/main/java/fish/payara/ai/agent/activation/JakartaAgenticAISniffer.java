 ...
 *     holder.
 */
package fish.payara.ai.agent.activation;

import com.sun.enterprise.module.HK2Module;
import fish.payara.ai.agent.connector.JakartaAgenticAIContainer;
...
/**
 * Sniffer for Jakarta Agentic AI to identify @Agent annotations on classes before deployment.
 * This enables the container to process agent-annotated classes and set up the workflow runtime.
 *
 * @author Luis Neto <luis.neto@payara.fish>
 */
@Service
@PerLookup
public class JakartaAgenticAISniffer implements Sniffer {

    private static final Logger logger = Logger.getLogger(JakartaAgenticAISniffer.class.getName());
    ...
    protected Class<?> getContainersClass() {
        return JakartaAgenticAIContainer.class;
    }
