...
//                put("org.eclipse.persistence.antlr", 66);
                ...
                put("fish.payara.server.core.security.ssl-impl", 228);
                put("fish.payara.server.core.security.websecurity", 229);
                ...
                put("fish.payara.server.core.web.gf-web-connector", 237);
                put("fish.payara.server.core.web.glue", 238);
                ...
                put("fish.payara.server.core.web.war-util", 245);
                put("fish.payara.server.core.web.web-embed.api", 246);
