...
public class ModuleMap {
    ...
    public static final Map<String, Integer> CONSTANT_MAP = 
            Collections.unmodifiableMap(new HashMap<String, Integer>() {{ 
                ...
                put("fish.payara.server.internal.external.ant", 181);
                put("fish.payara.server.internal.external.antlr-repackaged", 182);
                put("fish.payara.server.internal.external.dbschema-repackaged", 183);
                put("fish.payara.server.internal.external.j-interop-repackaged", 184);
                put("fish.payara.server.internal.external.jmxremote_optional-repackaged", 185);
                put("fish.payara.server.internal.external.ldapbp-repackaged", 186);
                put("fish.payara.server.internal.external.libpam4j-repackaged", 187);
                put("fish.payara.server.internal.external.schema2beans-repackaged", 188);
                put("fish.payara.server.internal.external.trilead-ssh2-repackaged", 189);
