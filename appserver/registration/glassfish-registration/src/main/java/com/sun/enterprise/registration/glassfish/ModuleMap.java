...
//                put("org.eclipse.persistence.antlr", 66);
                ...
                put("fish.payara.server.internal.security.jakarta.security.auth.message", 226);
                put("fish.payara.server.internal.security.jakarta.security.jacc", 227);
                put("fish.payara.server.internal.security.ssl-impl", 228);
                put("fish.payara.server.internal.security.websecurity", 229);
                put("fish.payara.server.internal.security.webservices.security", 230);
                put("fish.payara.server.internal.transaction.internal-api", 231);
                put("fish.payara.server.internal.transaction.jakarta.transaction", 232);
                put("fish.payara.server.internal.transaction.jta", 233);
                put("fish.payara.server.internal.transaction.jts", 234);
                put("fish.payara.server.internal.web.cli", 235);
                put("fish.payara.server.internal.web.core", 236);
                put("fish.payara.server.internal.web.gf-web-connector", 237);
                put("fish.payara.server.internal.web.glue", 238);
                put("fish.payara.server.internal.web.gui-plugin-common", 239);
                put("fish.payara.server.internal.web.ha", 240);
                put("fish.payara.server.internal.web.jsf-connector", 241);
                put("fish.payara.server.internal.web.jspcaching-connector", 242);
                put("fish.payara.server.internal.web.jstl-connector", 243);
                put("fish.payara.server.internal.web.naming", 244);
                put("fish.payara.server.internal.web.war-util", 245);
                put("fish.payara.server.internal.web.web-embed.api", 246);
                put("fish.payara.server.internal.web.web-embed.impl", 247);
                put("fish.payara.server.internal.web.weld-integration", 248);
                put("fish.payara.server.internal.web.weld-integration-fragment", 249);
                put("fish.payara.server.internal.webservices.connector", 250);
                put("fish.payara.server.internal.webservices.jsr109-impl", 251);
                put("fish.payara.server.internal.webservices.metro-glue", 252);
                put("fish.payara.server.internal.webservices.soap-tcp", 253);
                put("org.glassfish.metro.webservices-api-osgi", 254);
                put("org.glassfish.metro.webservices-extra-jdk-packages", 255);
                put("org.glassfish.metro.webservices-osgi", 256);
                put("org.glassfish.web.el-impl", 257);
                put("org.glassfish.web.jsp-impl", 258);
                put("org.glassfish.web.jstl-impl", 259);
                put("org.jboss.weld.osgi-bundle", 260);
                put("org.jvnet.mimepull", 261);
                put("org.shoal.cache", 262);
                put("org.shoal.gms-api", 263);
                put("org.shoal.gms-impl", 264);
                put("stax2-api", 265);
                put("woodstox-core-asl", 266);
                put("com.fasterxml.jackson.dataformat.xml", 267);
                put("org.objectweb.asm", 268);
                put("org.objectweb.asm.commons", 269);
                put("org.objectweb.asm.tree", 270);
                put("org.objectweb.asm.tree.analysis", 271);
                put("org.objectweb.asm.util", 272);
            }});
