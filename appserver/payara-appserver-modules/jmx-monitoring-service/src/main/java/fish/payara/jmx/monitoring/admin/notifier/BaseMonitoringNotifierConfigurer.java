 ...
 */
public abstract class BaseMonitoringNotifierConfigurer<C extends Notifier> implements AdminCommand {
        ...
        try {
            if (c == null) {
                ConfigSupport.apply(new SingleConfigCode<MonitoringServiceConfiguration>() {
                    @Override
                    public Object run(final MonitoringServiceConfiguration configurationProxy)
