...
@Service(name = "get-aws-config-source-configuration")
@PerLookup
...
@RestEndpoints({
        @RestEndpoint(configBean = MicroprofileConfigConfiguration.class,
                ...
                path = "get-aws-config-source-configuration",
                description = "List AWS Secrets Config Source Configuration")
})
public class GetAWSSecretsConfigSourceConfigurationCommand extends BaseGetConfigSourceConfigurationCommand<AWSSecretsConfigSourceConfiguration> {

    @Override
    protected Map<String, Object> getConfigSourceConfiguration(AWSSecretsConfigSourceConfiguration configuration) {
        ...
        if (configuration != null) {
            ...
            config.put("Secret Name", configuration.getSecretName());
        }
        return config;
    }
}
