...
@RestEndpoints({
    @RestEndpoint(configBean = MicroprofileConfigConfiguration.class,
            ...
            path = "get-dynamodb-config-source-configuration",
            description = "List DynamoDB Config Source Configuration")
})
public class GetDynamoDBConfigSourceConfigurationCommand extends BaseGetConfigSourceConfigurationCommand<DynamoDBConfigSourceConfiguration> {
