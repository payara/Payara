...
import static fish.payara.microprofile.openapi.impl.model.util.ModelUtils.overwrite;
...
public class SchemaImpl extends ExtensibleImpl implements Schema {
    ...
    public static void merge(org.eclipse.microprofile.openapi.annotations.media.Schema from, Schema to,
        ...
        if (from.implementation() != null && currentSchemas != null) {
            ...
            // If the implementation class is a schema
            if (implementationClass
                    .isAnnotationPresent(org.eclipse.microprofile.openapi.annotations.media.Schema.class)) {

                // Get the schema name
                String schemaName = implementationClass
                        .getDeclaredAnnotation(org.eclipse.microprofile.openapi.annotations.media.Schema.class).name();
                if (schemaName == null) {
        ...
        if (from.multipleOf() > 0) {
            to.setMultipleOf(mergeProperty(to.getMultipleOf(), BigDecimal.valueOf(from.multipleOf()), override));
        }
