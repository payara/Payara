...
public class ServerConfigSource extends PayaraConfigSource implements ConfigSource {
    ...
    public Map<String, String> getProperties() {
        return configService.getServerPropertyMap(configurationName);
    }

    @Override
    public int getOrdinal() {
        return configService.getConfig().getServerOrdinality();
    }

    @Override
    public String getValue(String propertyName) {
        return configService.getServerProperty(configurationName, propertyName);
    }
