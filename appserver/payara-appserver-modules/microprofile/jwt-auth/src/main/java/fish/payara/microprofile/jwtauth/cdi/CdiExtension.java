...
/**
 * This CDI extension installs the {@link JWTAuthenticationMechanism} and
 * related {@link SignedJWTIdentityStore} when the <code>LoginConfig</code>
 * annotation is encountered (MP-JWT 1.0 5).
 *
 * <p>
 * Additionally this extension checks that injection of claims are in the right
 * scope (non-transitively, 7.1.3).
 *
 * @author Arjan Tijms
 */
public class CdiExtension implements Extension {
    ...
    /**
     * Tracks whether a LoginConfig annotation has been encountered and thus a
    ...
    /**
     * This method tries to find the LoginConfig annotation and if does flags
     * that fact.
     *
     */
    ...
    /**
     * Find all the roles used by the <code>@RolesAllowed</code> annotation, so
     * these can be programmatically declared later on.
     *
     */
