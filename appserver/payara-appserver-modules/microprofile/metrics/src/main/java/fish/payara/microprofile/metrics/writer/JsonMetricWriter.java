...
public class JsonMetricWriter extends JsonWriter {
    ...
    public JsonMetricWriter(Writer writer, MetricsHelper helper) {
        super(writer, helper);
    }
    ...
    private JsonObject getJsonFromMetricMap(Map<String, Metric> metricMap) {
        ...
        for (Map.Entry<String, Metric> entry : metricMap.entrySet()) {
            ...
            if (Counter.class.isInstance(metric)) {
                ...
                payloadBuilder.add(metricName, getJsonFromMap(MetricsHelper.getTimerNumbers((Timer) metric)));
            } else if (Histogram.class.isInstance(metric)) {
                payloadBuilder.add(metricName, getJsonFromMap(MetricsHelper.getHistogramNumbers((Histogram) metric)));
            } else if (Meter.class.isInstance(metric)) {
                payloadBuilder.add(metricName, getJsonFromMap(MetricsHelper.getMeterNumbers((Meter) metric)));
            } else {
