...
public class MBeanExpression {
    ...
    public MBeanExpression(String expression) throws MalformedObjectNameException {
    ...
    public Object getAttribute() throws MalformedObjectNameException, MBeanException,
