...
public class JMXBeanMetadata extends Metadata {

    private String mbean;
    
    private boolean multi;

    public JMXBeanMetadata() {
        super(null, MetricType.INVALID);
    }
    
    public JMXBeanMetadata(String name, String displayName, String description, MetricType typeRaw, String unit) {
