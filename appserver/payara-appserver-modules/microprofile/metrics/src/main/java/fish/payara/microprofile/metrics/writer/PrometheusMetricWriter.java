...
public class PrometheusMetricWriter implements OutputWriter {
    ...
    private final MetricHelper helper;
    
    private static final Logger LOGGER = Logger.getLogger(PrometheusMetricWriter.class.getName());
    
    public PrometheusMetricWriter(Writer writer, MetricHelper helper) {
        this.writer = writer;
        this.helper = helper;
    }
    ...
    public void write() throws IOException {
        StringBuilder builder = new StringBuilder();
        for (String registryName : REGISTRY_NAMES_LIST) {
            try {
                writeMetricsAsPrometheus(builder, registryName);
    ...
    private void writeMetricsAsPrometheus(StringBuilder builder, String registryName) throws NoSuchRegistryException {
        writeMetricMapAsPrometheus(
                builder,
                registryName,
    ...
    private void writeMetricsAsPrometheus(StringBuilder builder, String registryName, String metricName) throws NoSuchRegistryException, NoSuchMetricException {
        writeMetricMapAsPrometheus(
                builder,
                registryName,
