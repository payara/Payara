...
import com.sun.enterprise.config.serverbeans.ConfigInjector;
...
/**
 * Tests the {@link ConfigInjector} business logic
 *
 * @author Jan Bernitt
 * @since 5.202
 */
public class CountedInterceptorTest {
    ...
    private void assertCounterIncrements(int expectedStartCount) throws Exception {
        ...
        try {
            ...
            assertEquals("No counter with name [" + reader.name(bean, element)
