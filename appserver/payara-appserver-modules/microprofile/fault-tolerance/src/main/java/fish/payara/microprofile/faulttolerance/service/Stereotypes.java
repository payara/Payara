...
public interface Stereotypes {
     ...
     * @return true, if the given annotation type is a sterotype annotation
     */
     ...
     * 
     * @param stereotype a sterotype annotation ({@link #isStereotype(Class)} was {@code true})
     * @return the set of annotation defined as sterotype
     */
