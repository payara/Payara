 ...
 * @author mertcaliskan
 */
@Service(name = "notification-datadog-configure")
@PerLookup
...
@RestEndpoints({
        @RestEndpoint(configBean = NotificationServiceConfiguration.class,
                ...
                path = "notification-datadog-configure",
                description = "Configures Datadog Notification Service")
})
public class DatadogNotificationConfigurer extends BaseNotificationConfigurer<DatadogNotifierConfiguration, DatadogNotifierService> {
    ...
    protected String getHealthCheckNotifierCommandName() {
        return "healthcheck-datadog-notifier-configure";
    }

    @Override
    protected String getRequestTracingNotifierCommandName() {
        return "requesttracing-datadog-notifier-configure";
    }
}
