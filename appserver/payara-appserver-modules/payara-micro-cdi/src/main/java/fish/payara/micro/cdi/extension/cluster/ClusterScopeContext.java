...
class ClusterScopeContext implements Context {
    ...
    public <TT> TT get(Contextual<TT> contextual, CreationalContext<TT> creationalContext) {
        ...
        if(rv == null) {
            ...
            getClusteredSingletonMap().putIfAbsent(getBeanName(bean, getAnnotation(bean)), rv);
        }
        return rv;
    }
    ...
    public <TT> TT get(Contextual<TT> contextual) {
        ...
        return (TT)getClusteredSingletonMap().get(beanName);
    }
    ...
    static private<TT> String getBeanName(Bean<TT> bean, Clustered annotation) {
    ...
    static private<TT> Clustered getAnnotation(Bean<TT> bean) {
