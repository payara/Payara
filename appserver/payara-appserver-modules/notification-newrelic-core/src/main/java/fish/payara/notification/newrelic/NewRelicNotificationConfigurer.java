 ...
 * @author mertcaliskan
 */
@Service(name = "notification-newrelic-configure")
@PerLookup
...
@RestEndpoints({
        @RestEndpoint(configBean = NotificationServiceConfiguration.class,
                ...
                path = "notification-newrelic-configure",
                description = "Configures New Relic Notification Service")
})
public class NewRelicNotificationConfigurer extends BaseNotificationConfigurer<NewRelicNotifierConfiguration, NewRelicNotifierService> {
    ...
    protected String getHealthCheckNotifierCommandName() {
        return "healthcheck-newrelic-notifier-configure";
    }

    @Override
    protected String getRequestTracingNotifierCommandName() {
        return "requesttracing-newrelic-notifier-configure";
    }
}
