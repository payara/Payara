...
public class GetNewRelicNotifierConfigurationCommand extends BaseGetNotifierConfigurationCommand<NewRelicNotifierConfiguration> {
    ...
    protected Map<String, Object> getNotifierConfiguration(NewRelicNotifierConfiguration configuration) {
        ...
        if (configuration != null) {
            ...
            map.put("Account ID", configuration.getAccountId());
        }
