...
/**
 * Configuration for the Dev Console Service.
 *
 * @author Gaurav Gupta
 */
@Configured(name = "dev-console-configuration")
public interface DevConsoleServiceConfiguration extends ConfigBeanProxy, ConfigExtension {
    ...
    /**
     * @return a String value defines the endpoint of dev-console service.
     */
    @Attribute(defaultValue = "dev")
    String getEndpoint();
