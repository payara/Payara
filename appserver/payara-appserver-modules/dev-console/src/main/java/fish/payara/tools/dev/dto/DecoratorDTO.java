...
public class DecoratorDTO extends DecoratorInfo {
    ...
    private List<fish.payara.tools.dev.model.Record> invocationRecords;
    ...
    public List<fish.payara.tools.dev.model.Record> getInvocationRecords() {
        return invocationRecords;
    }

    public void setInvocationRecords(List<fish.payara.tools.dev.model.Record> invocationRecords) {
