...
/**
 * AsAdmin command to get dev-console configuration
 * 
 * @author Gaurav Gupta
 */
@Service(name = "get-dev-console-configuration")
...
@RestEndpoints({
    @RestEndpoint(configBean = DevConsoleServiceConfiguration.class,
            opType = GET,
            path = "get-dev-console-configuration",
            description = "Gets the Dev Console Configuration")
})
public class GetDevConsoleConfigurationCommand implements AdminCommand {
    ...
    public void execute(AdminCommandContext adminCommandContext) {
        ...
        DevConsoleServiceConfiguration consoleConfiguration = targetConfig
                .getExtensionByType(DevConsoleServiceConfiguration.class);
        
        ColumnFormatter columnFormatter = new ColumnFormatter(OUTPUT_HEADERS);
        Object[] outputValues = {
            consoleConfiguration.getEnabled(),
            consoleConfiguration.getDynamic(),
            consoleConfiguration.getEndpoint(),
            consoleConfiguration.getVirtualServers(),
            consoleConfiguration.getSecurityEnabled(),
            consoleConfiguration.getRoles()
        };        
        ...
        extraPropertiesMap.put("enabled", consoleConfiguration.getEnabled());
        extraPropertiesMap.put("dynamic", consoleConfiguration.getDynamic());
        extraPropertiesMap.put("endpoint", consoleConfiguration.getEndpoint());
        extraPropertiesMap.put("virtualServers", consoleConfiguration.getVirtualServers());
        extraPropertiesMap.put("securityenabled", consoleConfiguration.getSecurityEnabled());
        extraPropertiesMap.put("roles", consoleConfiguration.getRoles());

        Properties extraProperties = new Properties();
        extraProperties.put("devConsoleConfiguration", extraPropertiesMap);
