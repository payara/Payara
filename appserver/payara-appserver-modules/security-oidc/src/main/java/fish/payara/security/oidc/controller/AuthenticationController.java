...
import static fish.payara.security.oidc.api.OidcConstant.DISPLAY;
import static fish.payara.security.oidc.api.OidcConstant.NONCE;
import static fish.payara.security.oidc.api.OidcConstant.PROMPT;
import static fish.payara.security.oidc.api.OidcConstant.REDIRECT_URI;
import static fish.payara.security.oidc.api.OidcConstant.RESPONSE_MODE;
import static fish.payara.security.oidc.api.OidcConstant.RESPONSE_TYPE;
import static fish.payara.security.oidc.api.OidcConstant.SCOPE;
...
public class AuthenticationController {
    ...
    /**
     * (1)
     * The RP (Client) sends a request to the OIDC Provider (OP) to
     * authenticates the End-User using the Authorization Code Flow and
     * authorization Code is returned from the Authorization Endpoint.(2)
    ...
    public AuthenticationStatus authenticateUser(
         ...
         * if url query param value is invalid then OIDC provider redirect to
         * error page (hosted in OP domain).
         */
