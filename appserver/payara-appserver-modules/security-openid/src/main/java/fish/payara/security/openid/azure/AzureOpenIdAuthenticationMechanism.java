...
public class AzureOpenIdAuthenticationMechanism extends OpenIdAuthenticationMechanism {
    ...
    public AzureOpenIdAuthenticationMechanism(AzureAuthenticationDefinition definition) {
        this();
        setConfiguration(definition);
    }

    public AzureOpenIdAuthenticationMechanism setConfiguration(AzureAuthenticationDefinition azureDefinition) {
        super.setConfiguration(toOpenIdAuthDefinition(azureDefinition));
        return this;
    }
