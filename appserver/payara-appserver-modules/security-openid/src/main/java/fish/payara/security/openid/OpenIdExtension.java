...
public class OpenIdExtension implements Extension {
     ...
     * @param beanManager
     */
    public <T> void findOpenIdDefinitionAnnotation(@Observes ProcessBean<T> bean, BeanManager beanManager) {
    ...
    private void validateExtraParametersFormat(OpenIdAuthenticationDefinition definition) {
