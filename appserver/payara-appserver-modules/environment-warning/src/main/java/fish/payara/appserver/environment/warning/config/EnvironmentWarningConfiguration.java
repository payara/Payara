 ...
 * holder.
 */
package fish.payara.appserver.environment.warning.config;
...
public interface EnvironmentWarningConfiguration extends ConfigBeanProxy, ConfigExtension {
    ...
    @Attribute(required = false, defaultValue = "Caution, you may be making changes to a production server.")
    String getMessage();
    public void setMessage(String message);
    
    @Attribute(required = false, defaultValue = "#D9534F")
