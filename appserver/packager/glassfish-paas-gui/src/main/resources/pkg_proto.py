...
pkg = {
    "name"          : "glassfish-paas-gui",
    "version"       : conf.glassfish_version,
    "attributes"    : {
                        "pkg.summary" : "GlassFish PaaS Administration Console",
                        "pkg.description" : "GlassFish Paas Administration Console decription placeholder.  "+conf.glassfish_description_long,
