...
Make sure to also check the Payara Server 4.1.2.191 Release Notes as they contain important information: https://docs.payara.fish/v/4./release-notes/release-notes-.html


5. Documentation 
================

Payara Server 4.1.2.191 Release Notes: https://docs.payara.fish/v/4./release-notes/release-notes-.html
