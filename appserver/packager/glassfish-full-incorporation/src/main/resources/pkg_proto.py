...
pkg = {
    ...
    "depends"       : { 
			...
			"pkg:/mq-server@5.0" : {"type" : "incorporate" },
			"pkg:/mq-bin-sh@5.0" : {"type" : "incorporate" },
			"pkg:/mq-bin-exe@5.0" : {"type" : "incorporate" },
                        "pkg:/mq-config-gf@5.0" : {"type" : "incorporate" },
			"pkg:/mq-locale@5.0" : {"type" : "incorporate" },
                      },
    "licenses"      : {
