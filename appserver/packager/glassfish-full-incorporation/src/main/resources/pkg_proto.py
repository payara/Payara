...
pkg = {
    ...
    "depends"       : { 
			...
			"pkg:/mq-server@4.6" : {"type" : "incorporate" },
			"pkg:/mq-bin-sh@4.6" : {"type" : "incorporate" },
			"pkg:/mq-bin-exe@4.6" : {"type" : "incorporate" },
                        "pkg:/mq-config-gf@4.6" : {"type" : "incorporate" },
			"pkg:/mq-locale@4.6" : {"type" : "incorporate" },
                      },
    "licenses"      : {
