...
/**
 * This implements IORToSocketInfo for ORB. Part of logic is from previous version of
        ...
        try {
            ...
            if (_logger.isLoggable(Level.FINE)) {
                ...
                _logger.log(Level.FINE,
                        baseMsg + ".getSocketInfo: ENDPOINT INFO:type=" + type + ",host=" + host + ", port=" + port);
            }
            ...
            if (socketInfo != null) {
                ...
                if (_logger.isLoggable(Level.FINE)) {
                    _logger.log(Level.FINE, baseMsg + ".getSocketInfo: returning SSL socketInfo:" + " " + socketInfo.getType()
                            + " " + socketInfo.getHost() + " " + socketInfo.getPort());
                }
            ...
            synchronized (this) {
                ...
                if (existing == null) {
                    ...
                    if (result.equals(existing)) {
                        ...
                        _logger.log(Level.FINE, baseMsg + ".getSocketInfo:" + " Address lists do not match: primary: "
                                + primarySocketInfo + "; returning current: " + result + "; existing is: " + existing);
                        return result;
                    }
                }
            }
