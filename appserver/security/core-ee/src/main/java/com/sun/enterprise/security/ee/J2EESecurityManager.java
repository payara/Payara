...
public class J2EESecurityManager extends java.rmi.RMISecurityManager {
     ...
     * System.out.flush(); // JDK 1.1. implementation... Class[] clss = getClassContext(); for(int i=1; i < clss.length;
     * ++i) { checkIfInContainer(clss[i]); } } // JDK 1.1. implementation... private void checkIfInContainer(Class clazz) {
     * Class[] parents = clazz.getDeclaredClasses(); for(int i=0; i < parents.length; ++i) { if(parents[i] ==
     * com.sun.ejb.Container.class) throw new SecurityException("Got it...."); } }
     */
