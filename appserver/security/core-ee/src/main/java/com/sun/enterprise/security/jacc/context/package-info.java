 ...
 * 
 * <p>
 * These handlers provide a number of convenient objects bound to thread local 
 * storage that can be obtained from "anywhere" like the current HTTP request and 
 * the current Subject.
 * 
 * <p>
