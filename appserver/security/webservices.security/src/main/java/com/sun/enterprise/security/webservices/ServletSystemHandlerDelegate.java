...
/**
 * The methods of this interface are invoked by the JAXRPCServletDelegate on the path to web sevice
 * endpoints deployed as servlets.
 *
 * NOTE: The methods of this interface may also be called on the client side of jaxrpc invocations,
 * although at this time, we have not decided from where such invocations would be made.
 *
 * @author Ron Monzillo
 */
