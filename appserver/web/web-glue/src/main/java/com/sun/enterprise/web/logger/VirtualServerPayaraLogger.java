...
/**
 * Special {@link PayaraLogger} used for some concrete virtual server.
 *
 * @author David Matejcek
 */
public final class VirtualServerPayaraLogger extends PayaraLogger {

    public VirtualServerPayaraLogger(final String name, final ResourceBundle rb) {
        super(name);
