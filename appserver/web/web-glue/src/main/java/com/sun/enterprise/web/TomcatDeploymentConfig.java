...
public class TomcatDeploymentConfig {
    ...
    protected static void configureFilterDef(WebModule webModule,
       ...
       List<ServletFilter> vector = wmd.getServletFilters();
    ...
    protected static void configureFilterMap(WebModule webModule,
                                             WebBundleDescriptorImpl wmd) {
        List<ServletFilterMapping> vector = wmd.getServletFilterMappingDescriptors();
        for (ServletFilterMapping servletFilterMapping : vector) {
            webModule.addFilterMap(servletFilterMapping);
        }
    }
    ...
    protected static void configureApplicationListener(
        ...
        List<AppListenerDescriptor> vector = wmd.getAppListenerDescriptors();
        for (AppListenerDescriptor appListenerDescriptor : vector) {
            webModule.addApplicationListener(appListenerDescriptor.getListener());
        }
