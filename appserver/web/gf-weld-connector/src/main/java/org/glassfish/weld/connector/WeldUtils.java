...
public class WeldUtils {
    ...
    public static final String WELD_MODULE_NAME = "org.jboss.weld.osgi-bundle";
    public static final String WELD_EXTENSION_MODULE_NAME = "org.glassfish.web.weld-integration-fragment";
}
