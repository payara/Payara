...
/**
 * Concurrency pool info definition
 */

@Configured
public interface PoolInfo extends ConfigBeanProxy {
     ...
     */
    void setCoreSize(String value) throws PropertyVetoException;
     ...
     * @param value allowed object is {@link String }
     */
    void setMaximumSize(String value) throws PropertyVetoException;
