...
public class StopDatabaseService implements AdminCommand {
    ...
    public void execute(AdminCommandContext context) {
        ...
        if (serviceUtil.isValidService(serviceName, ServiceUtil.SERVICE_TYPE.DATABASE)) {
            ...
            serviceUtil.updateState(serviceName, State.Stop_in_progress.toString(), ServiceUtil.SERVICE_TYPE.DATABASE);
            ...
            serviceUtil.updateState(serviceName, State.NotRunning.toString(), ServiceUtil.SERVICE_TYPE.DATABASE);
