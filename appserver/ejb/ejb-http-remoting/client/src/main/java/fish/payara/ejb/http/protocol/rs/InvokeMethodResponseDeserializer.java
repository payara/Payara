...
public class InvokeMethodResponseDeserializer implements JsonbDeserializer<InvokeMethodResponse> {
    ...
    private Type determineClass(String type) {
        // the type provided in response is only useful for non-parametrized, non-container types (and these are always
        // parametrized -- List<T>, Map<K,V>, ...)
