...
public class JpaTest {
    ...
    public JpaTest(EntityManagerFactory emf, EntityManager em, UserTransaction utx, PrintWriter out) {
        this.emf = emf;
        this.em = em;
        this.utx = utx;
        this.out = out;
    ...
    public boolean lazyLoadingByQuery(String fName) {
        ...
        Query query = em.createQuery("SELECT e FROM Employee e WHERE e.firstName like :firstName").setParameter("firstName", fName);
        ;
