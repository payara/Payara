...
package test.deploymentgroupteardown;

import com.sun.appserv.test.AdminBaseDevTest;
import org.testng.annotations.Test;
import org.testng.Assert;

public class DeploymentGroupTeardownTest extends AdminBaseDevTest {

    @Override
    protected String getTestDescription() {
        return "QL Group TEARDOWN Test";
    }
    ...
    public void deleteDeploymentGroupTest() throws Exception {
        ...
        retStatus = report(tn + "delete-deployment-group", ar1.returnValue);

        Assert.assertTrue(retStatus, "Error deleting deployment group " + cname + ": " + ar1.outAndErr);
    }
}
