...
/**
 * Test to check that when an application bundles a JSF implementation in with itself, it needs to set 'useBundledJsf'
 * to true and tell the class loader to not delegate to its parent.
 */
@RunWith(PayaraArquillianTestRunner.class)
public class DontUseBundledJsfTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "dontusebundledjsfprimefaces.war")
                ...
                .addAsLibraries(Libraries.resolveMavenCoordinatesToFiles("org.primefaces:primefaces:jar:jakarta:" + System.getProperty("primefaces.version")));
    }
    ...
    public void checkFacesContextImplementationVersion() {
        ...
        // Check that we're NOT using the bundled JSF version
