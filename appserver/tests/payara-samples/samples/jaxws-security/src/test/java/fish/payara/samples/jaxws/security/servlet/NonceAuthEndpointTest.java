...
/**
 * Runs nonce authentication tests with HA mode off (single-node default).
 * Metro selects NonHANonceManager, which uses a local in-memory nonce cache.
 *
 * @see NonceAuthHaEndpointTest for the HA-mode variant.
 */
@RunWith(PayaraArquillianTestRunner.class)
@NotMicroCompatible
@SincePayara("5.89.0")
public class NonceAuthEndpointTest extends NonceAuthEndpointTestBase {
