...
import fish.payara.samples.ParameterRule;
...
public abstract class AbstractClient {
    ...
    @Rule
    public ParameterRule<RemoteConnector> parameters = new ParameterRule<>(Arrays.asList(RemoteConnector.values()));

    @Before
    public void lookup() throws NamingException {
        remoteService = getConnector().lookup(String.format("java:global%sRemoteServiceBean", uri.getPath()));
    }

    abstract RemoteConnector getConnector();
