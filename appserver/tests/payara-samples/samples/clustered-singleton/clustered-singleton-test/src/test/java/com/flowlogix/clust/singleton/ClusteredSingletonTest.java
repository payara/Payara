...
import com.flowlogix.clust.singleton.api.Secondary;
...
public class ClusteredSingletonTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "cst.war")
                .addPackages(false, "com.flowlogix.clust.singleton",
                        "com.flowlogix.clust.singleton.api", "com.flowlogix.clust.singleton.interceptor")
