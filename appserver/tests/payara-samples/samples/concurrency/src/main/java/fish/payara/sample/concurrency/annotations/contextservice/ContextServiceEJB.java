...
@ManagedExecutorDefinition(name = "java:app/concurrent/MES3",
        maxAsync = 3,
        context = "java:app/concurrent/ContextC")
@Stateless
public class ContextServiceEJB {

    public static final Logger logger = Logger.getLogger(ContextServiceEJB.class.getName());

    @Resource(lookup = "java:app/concurrent/MES1")
    ManagedExecutorService mes1;
    ...
    public String processContextServiceFromAnnotation() throws InterruptedException, ExecutionException {
        ...
        Future<String> future = mes1.submit(() -> {
    ...
    public String processContextServiceMultipleAnnotation() throws InterruptedException, ExecutionException {
        IntContextProvider.setValue(10);
        Future<String> future1 = mes1.submit(() -> {
