...
public class ManagedScheduledExecutorApplicationIT {

    private final static Logger logger = Logger.getLogger(ManagedScheduledExecutorApplicationIT.class.getName());
    ...
    public static Archive<?> createDeployment() {
        ...
        JavaArchive ejbJar = ShrinkWrap.create(JavaArchive.class, "ejb-jar.jar")
                ...
                .addAsResource("ejb-jar3.xml", "META-INF/ejb-jar.xml");
        System.out.println(ejbJar.toString(true));
        //Creating web module
        WebArchive webWar = ShrinkWrap.create(WebArchive.class, "test.war")
                .addClasses(ManagedScheduledExecutorApplication.class, ManagedScheduledExecutorEJBRest.class);
    ...
    @Test
    @DisplayName("testing ManagedScheduledExecutor tag from Application EAR")
    @RunAsClient
    public void processManagedScheduledExecutorFromApplicationConfig() throws MalformedURLException {
