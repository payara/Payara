...
public class TestResource {
    ...
    public String getNonExistent() {
        return config.getValue("fish.payara.samples.microprofile.config.nonexistent", String.class);
    }

    @GET
    @Path("/getNonExistentOptional")
    public String getNonExistentOptional() {
