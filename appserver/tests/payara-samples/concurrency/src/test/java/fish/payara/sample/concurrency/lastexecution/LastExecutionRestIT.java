 ...
 * holder.
 */
package fish.payara.sample.concurrency.lastexecution;
...
public class LastExecutionRestIT {

    private final static Logger logger = Logger.getLogger(LastExecutionRestIT.class.getName());
