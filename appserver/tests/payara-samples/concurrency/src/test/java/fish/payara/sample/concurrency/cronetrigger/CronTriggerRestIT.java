 ...
 * holder.
 */
package fish.payara.sample.concurrency.cronetrigger;

import fish.payara.sample.concurrency.crontrigger.CronTriggerRest;
import fish.payara.sample.concurrency.crontrigger.CronTriggerRestApplication;
...
public class CronTriggerRestIT {

    private final static Logger logger = Logger.getLogger(CronTriggerRestIT.class.getName());
    ...
    @RunAsClient
    public void testCronTrigger() throws MalformedURLException {
        logger.log(Level.INFO, "Consuming service to submit CronTrigger execution {0}", new Object[]{client});
        WebTarget target = this.client.target(new URL(this.base, "concurrency/cronTrigger").toExternalForm());
