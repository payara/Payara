...
public class PackageProcessorService {
    ...
    private static final Logger LOG = Logger.getLogger(PackageProcessorService.class.getName());
    ...
    public List<WrappedDataPackage> processPackages(int size) {
        LOG.log(Level.INFO, "[PackageProcessorService, Generating] - Will start process for {0} instructions", size);
    ...
    public List<MarkedPackage> markPackages(int size){
        LOG.log(Level.INFO, "[PackageProcessorService, Marking] - Will start process for {0} instructions", size);
