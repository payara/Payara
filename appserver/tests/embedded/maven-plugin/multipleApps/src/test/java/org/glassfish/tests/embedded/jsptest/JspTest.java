...
//    private static int count = 0;
    ...
    public void testWeb() throws Exception {
        ...
        goGet("http://localhost:8080/firstapp", "Hi, my name is Bhavani. What's yours?");
        goGet("http://localhost:8080/firstapp/JspTestServlet", "Hi from JspTestServlet");

        // test secure access
        goGet("https://localhost:8181/firstapp", "Hi, my name is Bhavani. What's yours?");
        goGet("https://localhost:8181/firstapp/JspTestServlet", "Hi from JspTestServlet");
