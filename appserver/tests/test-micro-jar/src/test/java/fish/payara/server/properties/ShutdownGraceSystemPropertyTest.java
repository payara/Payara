...
public class ShutdownGraceSystemPropertyTest {

    /**
     * The tests sets the grace period to 3 seconds. This should be long enough to notably delay shutdown but not too
     * long to make test execution unnecessarily slow.
     */
    @Test
    public void shutdownGraceSystemPropertyHasDelayEffect() {
        System.setProperty("fish.payara.shutdowngrace", "3000"); //ms
    ...
    public void clearSystemProperty() {
        System.clearProperty("fish.payara.shutdowngrace");
    }
}
