 ...
 * holder.
 */
package fish.payara.admin.cli.network;
...
import fish.payara.test.domain.network.HazelcastRuntimeConfiguration;

/**
 * Verifies the correctness of the {@code SetHazelcastConfiguration} command.
 */
public class SetHazelcastConfigurationTest extends AsAdminIntegrationTest {

    private HazelcastRuntimeConfiguration config;

    @Before
    public void setUp() {
        config = HazelcastRuntimeConfiguration.from(server);
    }

    @Test
    public void setHazelcastConfiguration_AutoIncrementPort() {
        ClusterCommandResult result = asadmin("set-hazelcast-configuration",
