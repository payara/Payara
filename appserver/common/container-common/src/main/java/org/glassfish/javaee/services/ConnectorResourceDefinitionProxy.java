 ...
 *
 * This is used for @ConnectorResourceDefinition<br>
 * Upon first lookup, the connector-resource is created, deployed and the internal jndi-name is given to the
...
@Service
@PerLookup
public class ConnectorResourceDefinitionProxy implements NamingObjectProxy.InitializationNamingObjectProxy, Serializable{
    ...
    public void setDescriptor(ConnectorResourceDefinitionDescriptor desc){
        this.desc = desc;
    }
