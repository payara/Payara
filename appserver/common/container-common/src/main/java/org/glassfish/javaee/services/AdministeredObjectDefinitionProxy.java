 ...
 *
 * This is used for @AdministeredObjectDefinition<br>
 * Upon first lookup, the administered-object is created, deployed and the internal jndi-name is given to the
...
@Service
@PerLookup
public class AdministeredObjectDefinitionProxy implements NamingObjectProxy.InitializationNamingObjectProxy, Serializable{

    private static final long serialVersionUID = 9212467922706039906L;
    ...
    public Object create(Context ic) throws NamingException {
        if(actualResourceName == null){
            ...
            actualResourceName = ConnectorsUtil.deriveAdministeredObjectDefinitionResourceName(desc.getResourceId(), desc.getName());
    ...
    public void setDescriptor(AdministeredObjectDefinitionDescriptor desc){
        this.desc = desc;
    }
