 ...
 *
 * This is used for @JMSConnectionFactoryDefinition<br>
 * Upon first lookup, the jms-connection-factory is created, deployed and the internal jndi-name is given to the
...
@Service
@PerLookup
public class JMSConnectionFactoryDefinitionProxy implements NamingObjectProxy.InitializationNamingObjectProxy, Serializable {

    private static final long serialVersionUID = 2441125757350019585L;
    ...
    public synchronized Object create(Context ic) throws NamingException {
        if (actualResourceName == null) {
            ...
            actualResourceName = ConnectorsUtil.deriveJMSConnectionFactoryDefinitionResourceName
    ...
    public void setDescriptor(JMSConnectionFactoryDefinitionDescriptor desc){
        this.desc = desc;
    }
