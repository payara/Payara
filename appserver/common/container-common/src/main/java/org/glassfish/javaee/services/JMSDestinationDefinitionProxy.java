 ...
 *
 * This is used for @JMSDestinationDefinition<br>
...
@Service
@PerLookup
public class JMSDestinationDefinitionProxy implements NamingObjectProxy.InitializationNamingObjectProxy, Serializable {

    private static final long serialVersionUID = 1387639097037563897L;
    ...
    public synchronized Object create(Context ic) throws NamingException {
        if (actualResourceName == null) {
            ...
            actualResourceName = ConnectorsUtil.deriveJMSDestinationDefinitionResourceName
    ...
    public void setDescriptor(JMSDestinationDefinitionDescriptor desc){
        this.desc = desc;
    }
