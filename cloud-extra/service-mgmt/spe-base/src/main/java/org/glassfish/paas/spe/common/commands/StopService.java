...
/**
 * This is an additional command in order to be able to stop a service manually.
 * <p/>
 * This should not be used unless a service needs to be forcefully stoppped.
 *
 * @author bhavanishankar@java.net
 */
@Service(name = "_stop-service")
@PerLookup
@CommandLock(CommandLock.LockType.NONE)
public class StopService implements AdminCommand {
    ...
    public void execute(AdminCommandContext context) {
        ...
        try {
            ...
            report.setMessage("Unable to stop service [" + serviceName + "]");
